...
let yourAttacks=[],opponentAttacks=[]
...
async function setstats(){
    ...
    yourAudio=new Audio(`https://raw.githubusercontent.com/PokeAPI/cries/main/cries/pokemon/latest/${your_poke_id}.ogg`)
    hisAudio=new Audio(`https://raw.githubusercontent.com/PokeAPI/cries/main/cries/pokemon/latest/${opponent_poke_id}.ogg`)
...
async function gameloop(){
    ...
    while(yourHP>0 && opponentHp >0){
        ...
        x= Math.floor(Math.random() *opponentAttacks.length)   // opponents attack
